#line 1 "c:\\Users\\a.rondon\\Documents\\GitHub\\BlackSabbath\\src\\class_File.h"
...
public:
    ...
    inline void writeUDP(uint16_t *buffer, uint16_t size, IPAddress targetIP, uint16_t targetPort) __attribute__((always_inline));
#endif
#ifdef EXTMEMORY_ON
