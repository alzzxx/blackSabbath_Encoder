...
void ServerEncoder::serverBody(EthernetClient client)
{
    ...
    client.println(F("<button class='button' onclick='ajaxSendReset()'>Enable encoder</button>"));
    client.println(F("</div>"));
    client.println(F("</div>"));
    client.println(F("</div>"));
    ...
    client.println(F("<td rowspan='4'></td>"));
    client.println(F("<td class='description' rowspan='4' style='text-align: left;'>IP Address for the ethernet interface of the device; p02[0] to p02[2] are fixed while P02[3] is computed as: 20 + p01"));
    client.println(F("</td>"));
    client.println(F("<tr>"));
